...
const Footer = () => {
  return (
    <section className="w-full bg-[#0F3B34] text-white pt-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <footer className="bg-[#0F3B34] text-white pt-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-8">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-12 w-full md:w-auto">
              <p className="text-green-100 leading-relaxed max-w-md relative">
                ...
                <span>
                  <Image
                    ...
                    width={300}
                    height={300}
                    className="absolute -top-10 right-0 opacity-30 hidden md:block"
                  />
                </span>
              </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 pb-8 gap-6">
        ...
        <div className="text-gray-200/40 text-md max-w-screen p-4 mx-auto border-t border-gray-200/40">
          <h1 className="max-w-7xl mx-auto text-center">
